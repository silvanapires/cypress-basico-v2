...
describe('Central de Atendimentoao Cliente TAT', function() {
	beforeEach(function(){
	...
	it('exibe mensagem de erro ao submeter o formulario com um email com formatacao invalida', function(){
		cy.get('#firstName').type('Silvana')
		cy.get('#lastName').type(' Pires da Silva')
		cy.get('#email').type('silvana_piressilva@hotmail')
	...
	it('campo telefone continua vazio quando preenchido com valor não numerico', function(){
		cy.get('#phone')
		.type('dnsdnjsdjshdjsh')
		.should('have.value', '')

	})

	it('exibe mensagem de erro quando o telefone se torna obrigtorio mas nao é preeenchido antes de envio de formulário', function(){
		cy.get('#firstName').type('Silvana')
		cy.get('#lastName').type(' Pires da Silva')
		cy.get('#email').type('silvana_piressilva@hotmail.com')
	...
	it('exibe mensagem de erro ao submeter o fomrulario sem preencher os campos obrigatorios', function(){
